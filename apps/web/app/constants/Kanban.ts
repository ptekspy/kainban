...
export const KANBAN_COLUMN_SETTINGS: Record<KanbanColumnKey, { statusColor: string; backgroundColor: string }> = {
    TODO: { statusColor: "bg-gray-500", backgroundColor: "bg-gray-100" },
    READY_FOR_DEVELOPMENT: { statusColor: "bg-yellow-500", backgroundColor: "bg-yellow-100" },
    IN_DEVELOPMENT: { statusColor: "bg-blue-500", backgroundColor: "bg-blue-100" },
    READY_FOR_REVIEW: { statusColor: "bg-purple-500", backgroundColor: "bg-purple-100" },
    IN_REVIEW: { statusColor: "bg-indigo-500", backgroundColor: "bg-indigo-100" },
    READY_FOR_RELEASE: { statusColor: "bg-green-500", backgroundColor: "bg-green-100" },
    IN_RELEASE: { statusColor: "bg-teal-500", backgroundColor: "bg-teal-100" },
    HUMAN_INTERVENTION: { statusColor: "bg-red-500", backgroundColor: "bg-red-100" },
    RELEASED: { statusColor: "bg-gray-700", backgroundColor: "bg-gray-200" },
}

export const KANBAN_FLOW: Record<KanbanColumnKey, { from: KanbanColumnKey[]; to: KanbanColumnKey[] }> = {
    TODO: {
        from: [],
    ...
    HUMAN_INTERVENTION: {
        from: ["READY_FOR_DEVELOPMENT", "IN_DEVELOPMENT", "READY_FOR_REVIEW", "IN_REVIEW", "READY_FOR_RELEASE", "IN_RELEASE"],
        to: ["READY_FOR_DEVELOPMENT", "IN_DEVELOPMENT", "READY_FOR_REVIEW", "IN_REVIEW", "READY_FOR_RELEASE", "IN_RELEASE"],
    },
    RELEASED: {
        from: ["IN_RELEASE"],
        to: [],
